...
void boot_screen_create(void)
{
    ...
    // boot_logo2 = lv_img_create(boot_screen);
    // lv_img_set_src(boot_logo2, &ui_img_gc8_green);
    // lv_obj_center(boot_logo2);
    // lv_obj_set_style_opa(boot_logo2, LV_OPA_0, 0);
}
