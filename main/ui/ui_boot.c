/**
 * ui_boot.c — Toyota boot splash, left cluster.
 *
 * Timeline:
...
void ui_boot_start(lv_obj_t *parent, ui_boot_done_cb_t on_done)
{
    ...
    /* Logo emerges from black (overlay already opaque). */
    lv_anim_t fade_in;
    ...
    /* Overlay fade-out matches fade-in timing for a symmetric dissolve to live UI. */
    lv_anim_t fade_out;
